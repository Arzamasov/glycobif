...
4. **Prediction accuracy and caveats**: While glycobif achieves high (>94%) overall phenotype prediction accuracy for isolates, benchmarking against *in vitro* growth data in [Arzamasov et al., 2024](https://doi.org/10.1101/2024.07.06.602360) identified two sources of errors:
